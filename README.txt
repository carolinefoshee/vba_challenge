...
Note: Running the code with that large of an Excel file made my computer crash. So the min/max/greatest volume data is only for rows 1 to 10000. Also, GitHub would not let me upload the large file of code. So I have attached the alphabetical_testing file on which the VBA code can be run.
